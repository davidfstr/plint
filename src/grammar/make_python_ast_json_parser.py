...
print('''
(*
 * This file is generated by make_python_ast_json_parser.py based on
 * the grammar in Python.asdl.json. Any manual changes made will be lost
 * upon the next regeneration of this file.
 *)
